...
Device *BluePrint::GetDevice(std::string refId) { return this->device; }

Device *BluePrint::GetDevice() { return this->device; }
...
void BluePrint::AddSubElement(string groupRefId, string name, string desc,
