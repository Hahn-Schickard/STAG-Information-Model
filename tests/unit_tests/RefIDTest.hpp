...
TEST(RefIdTests, DeviceElementRefIdIsCorrect) {
  // Arrange
  // DeviceElement *element = new DeviceElement("1234", "TestDevice", "A
  // hardcoded deviceelement", ElementType::Group);
...
TEST(RefIdTests, DeviceElementGroupRefIdIsCorrect) {
  // Arrange
  // DeviceElementGroup *element = new DeviceElementGroup("1234", "TestDevice",
