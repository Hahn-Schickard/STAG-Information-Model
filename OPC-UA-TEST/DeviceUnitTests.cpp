...
//	public:
//		Device * device;
//		DeviceElementGroup deviceElementGroup = DeviceElementGroup("123","","");
//
//		DeviceTest()
//		{
//
...
//			deviceElementGroup = DeviceElementGroup(device->getReferenceId() + ".1", device->getElementName() + " group", "Group Element of " + device->getElementName());
//		}
//
